...
export class CityComponent implements OnInit {
  ...
  /*returnRandomI() generates and returns a random number between 0 and 251.*/
  returnRandomI() {
    var max = 251;
  ...
  /*searchI() concatenates entered city with the URL to create url that is passed into window.fecth().*/
  searchI() {
